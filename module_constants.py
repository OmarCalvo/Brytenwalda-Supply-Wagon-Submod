...
max_trade_wagon_profit = 8000 #Profit limit from supply wagon. Equivalent to about 2000 per town merchant, on average.
max_days_hide_wagon = 10	#maximum number of days hidden wagon is going to remain in hiding.
prob_discovery_hidden_wagon = 3 # probability that hidden wagon is discovered, per day.
hidden_wagon_state_none = 0 # wagon is not a hidden wagon (normal wagon)
hidden_wagon_state_hiding = 1 #wagon in hiding
hidden_wagon_state_returning = 2 #hidden wagon returning to main_party
